...
subfile[0]=new Array(0), file[0]="", item[0]="首 頁";
subfile[1]=new Array(0), file[1]="news.html", item[1]="最新消息";
subfile[2]=new Array(5), file[2]="summary.html", item[2]="中譯文件";
subfile[3]=new Array(0), file[3]="search.html", item[3]="搜尋引擎";
subfile[4]=new Array(0), file[4]="doc/", item[4]="其它中文文件";
subfile[5]=new Array(4), file[5]="about.html", item[5]="關於本計劃";
subfile[6]=new Array(0), file[6]="glossary.html", item[6]="翻譯小辭典";
subfile[7]=new Array(2), file[7]="mailing.html", item[7]="通信論壇";
subfile[8]=new Array(0), file[8]="HOWTO-INDEX-3.html", item[8]="英文 HOWTOs";
subfile[9]=new Array(0), file[9]="links.html", item[9]="網站連結";
...
subfile[2][3]="assigned.html", subitem[2][3]="翻譯中文件";
subfile[2][4]="unassigned.html", subitem[2][4]="未翻譯文件";

// Sub menus 5
subitem[5]=new Array(5)
subfile[5][0]=false;
subfile[5][1]="manifesto.html", subitem[5][1]="聲 明";
subfile[5][2]="join.html", subitem[5][2]="參與計劃";
...
function CheckHash()
{
	...
	return (pathname.indexOf("/HOWTO/") != -1) ? "Linux HOWTOs Online" : "Linux 中文文件計劃";
}
...
function DrawMenu()
{
    ...
    with (document) {
        ...
        if (i_menu == 0 && i_item == 0) {
			enc=(big5 ? "GB 碼".link("gb/") : "BIG5 碼".link("../")).bold();
